...
public class RQSKPSPublicSoap
{
    ...
    public RQSKPSPublicSoap(){}

    public RQSKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public RQSKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        RQSExtendedSoapSerializationEnvelope envelope= new RQSExtendedSoapSerializationEnvelope(RQSExtendedSoapSerializationEnvelope.VER11);
